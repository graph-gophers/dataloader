...
func TestLoader(t *testing.T) {
	...
	t.Run("test LoadMany returns errors", func(t *testing.T) {
		...
		ctx := context.Background()
		future := errorLoader.LoadMany(ctx, KeyList{StringKey("1"), StringKey("2"), StringKey("3")})
		_, err := future()
		if len(err) != 3 {
	...
	t.Run("test LoadMany returns len(errors) == len(keys)", func(t *testing.T) {
		...
		ctx := context.Background()
		future := loader.LoadMany(ctx, KeyList{StringKey("1"), StringKey("2"), StringKey("3")})
		_, errs := future()
		if len(errs) != 3 {
	...
	t.Run("test LoadMany returns nil []error when no errors occurred", func(t *testing.T) {
		...
		loader, _ := IDLoader(0)
		ctx := context.Background()
		_, err := loader.LoadMany(ctx, KeyList{StringKey("1"), StringKey("2"), StringKey("3")})()
		if err != nil {
	...
	t.Run("test thunkmany does not contain race conditions", func(t *testing.T) {
		...
		identityLoader, _ := IDLoader(0)
		ctx := context.Background()
		future := identityLoader.LoadMany(ctx, KeyList{StringKey("1"), StringKey("2"), StringKey("3")})
		go future()
		go future()
	})
	...
	t.Run("test Load Many Method Panic Safety", func(t *testing.T) {
		...
		panicLoader, _ := PanicLoader(0)
		ctx := context.Background()
		future := panicLoader.LoadMany(ctx, KeyList{StringKey("1")})
		_, errs := future()
